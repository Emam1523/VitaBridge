						...
						{doctors.map((doctor, index) => (
							...
							>
								...
								<div className="flex items-start gap-4">
									<div className="flex h-14 w-14 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-primary-100 text-xl font-bold text-primary-700">
									...
									<div className="flex-1 min-w-0">
										...
										<p className="mt-1 text-sm text-gray-500">{doctor.phoneNumber || "Phone not available"}</p>
									</div>
